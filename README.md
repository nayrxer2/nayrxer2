...
![PHP Web App](https://github.com/johndoe/php-web-app) – A dynamic web application built with **PHP** on the backend.
...
![Figma Design Templates](https://github.com/johndoe/figma-designs) 
![Agile Project Management with Jira](https://github.com/johndoe/jira-projects) 
![Trello Task Board](https://github.com/johndoe/trello-board)
